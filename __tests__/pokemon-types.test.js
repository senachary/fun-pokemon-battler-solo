const { FireType , WaterType, GrassType, NormalType} = require("../classes/pokemon-types");
...
describe("4 types that extend from the Pokemon base class", () => {
    ...
    describe.only('methods on type class', () => {
        describe('isEffectiveAgainst', () => {
            test('subclass contains isEffectiveAgainst method', () => {
                ...
                //Assert
                expect(Object.getPrototypeOf(testFire)).toHaveProperty('isEffectiveAgainst')
                expect(Object.getPrototypeOf(testWater)).toHaveProperty('isEffectiveAgainst')
                expect(Object.getPrototypeOf(testGrass)).toHaveProperty('isEffectiveAgainst')
                expect(Object.getPrototypeOf(testNormal)).toHaveProperty('isEffectiveAgainst')
            })
            ...
            describe('WaterType.isEffectiveAgainst', () => {
                test('Returns true for WaterType if given opponent is water type', () => {
                    //Arrange
                    const testWater = new WaterType()
                    const testFire = new FireType()
                    //Assert
